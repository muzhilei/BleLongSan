...
/** @Description CRC16校验, 查表法版本：速度快，语句少，但表格占用一定的程序空间。 @Autuor Mr.Qu @Date 2019/3/19 0019 */
public class CRC16Utils {
    ...
    public static void main(String[] args) {
        byte[] data = {0X00, 0X00, 0X00, 0X08, 0X27, 0X13};
        System.out.println(getCrc(calcCrc16(data)));
    }
}
