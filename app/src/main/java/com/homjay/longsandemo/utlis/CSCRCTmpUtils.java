...
/**
 * Created by zjc on 2022/4/24 0024  09:09.
 * 长桑CRC验证工具类
 */
public class CSCRCTmpUtils {
     ...
     */
    public static byte[] getCRC16ReturnBytes(byte[] data,int size) {
        int crc = 0xff;
        int ucCRCHi = 0xff;
        int ucCRCLo = 0xff;
        int iIndex;
        ...
        byte[] tmp=new byte[2];
        tmp[0]=(byte)(ucCRCHi & 0x00ff);
        tmp[1]=(byte)(ucCRCLo & 0x00ff);
